...
INSERT INTO posts (title, topic_id, content, owner_id, created_at) VALUES ('Les bases de JavaScript', 2, 'JavaScript est un langage de programmation léger et dynamique, principalement utilisé pour le développement web côté client, permettant d\'ajouter de l\'interactivité aux pages web.', 1, CURRENT_TIMESTAMP+1);
INSERT INTO posts (title, topic_id, content, owner_id, created_at) VALUES ('Créer des applications avec spring boot', 1, 'Spring Boot est un framework Java open-source qui facilite la création d\'applications autonomes et prêtes pour la production, en simplifiant la configuration et le déploiement.', 2, CURRENT_TIMESTAMP+2);
INSERT INTO posts (title, topic_id, content, owner_id, created_at) VALUES ('Les composants en React', 4, 'React est une bibliothèque JavaScript développée par Facebook, utilisée pour construire des interfaces utilisateur interactives et réactives, en se basant sur des composants réutilisables.', 2, CURRENT_TIMESTAMP+3);
